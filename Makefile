...
stage : rel
	$(foreach dep,$(wildcard deps/*), rm -rf rel/tiger/lib/$(shell basename $(dep))-* && ln -sf $(abspath $(dep)) rel/tiger/lib;)
...
docs:
	...
	@cp -R apps/tiger_core/doc doc/tiger_core
	@cp -R apps/tiger_kv/doc doc/tiger_kv

orgs: orgs-doc orgs-README

orgs-doc:
	@emacs -l orgbatch.el -batch --eval="(tiger-export-doc-dir \"doc\" 'html)"

orgs-README:
	@emacs -l orgbatch.el -batch --eval="(tiger-export-doc-file \"README.org\" 'ascii)"
...
# Ex: When on a tag:            tiger-1.0.3   (no commits since tag)
#     For most normal Commits:  tiger-1.1.0pre1-27-g1170096
#                                 Last tag:          tiger-1.1.0pre1
